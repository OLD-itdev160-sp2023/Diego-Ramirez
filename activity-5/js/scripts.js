...
(function() {
    ...
    {
        name: 'atom-beautify', 
        description: 'The atom-beautify package will clean up your code and make it more readible.',
        author: 'Glavin001',
    ...
    /**
     * Writes the package object's data to the appropiate
     * DOM elements utilizing the package selector proprerty 
     * @param {Package} package
     * @return{void}
     */
    var writePackageInfo = function (package) {
        //Get refence to DOM elements
        ...
        downloadEl.textContent = package.download;
        startsEl.textContent = package.stars;
    };
